	...
	<div class="row">
		<div class="col-md-6">
			...
			<select class="form-control" id="form_display_type">
				<option value="1" <?php if ($display_type==0) echo "selected";?>>1. Images on right.</option>
				<option value="2" <?php if ($display_type==1) echo "selected";?>>2. Images on grid below.</option>
			</select><br />
			<div class="form-group">
